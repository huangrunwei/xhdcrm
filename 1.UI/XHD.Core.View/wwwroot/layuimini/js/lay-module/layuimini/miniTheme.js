        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://www.xhdcrm.com" target="_blank"><i class="layui-icon layui-icon-ie"></i> 官方网站</a>\n' +
                    '<a class="more-menu-item" href="tencent://message/?uin=250476029&Site=&Menu=yes" target="_blank"><i class="layui-icon layui-icon-login-qq"></i> QQ:250476029</a>\n' +
                    '<a class="more-menu-item" ><i class="layui-icon layui-icon-login-wechat"></i> 手机/微信：13467644655</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
