...
layui.define(["jquery", "miniMenu", "element","miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        renderLogo: function (data) {
            //var html = '<a href="' + data.href + '"><img src="' + data.image + '" alt="logo" style="max-width:200px;overflow:hidden;"><h1>' + data.title + '</h1></a>';
            var html = '<a ><img src="' + data.image + '" alt="logo" style="max-width:200px;overflow:hidden;"><h1>' + data.title + '</h1></a>';
